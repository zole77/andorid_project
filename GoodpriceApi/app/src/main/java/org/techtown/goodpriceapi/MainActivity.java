...
public class MainActivity extends AppCompatActivity {
    ...
    String getXmlData(){
        ...
        String sj = URLEncoder.encode(str);
        String query="%EC%A0%84%EB%A0%A5%EB%A1%9C";

        String queryUrl="http://apis.data.go.kr/6260000/GoodPriceStoreService/getGoodPriceStore?serviceKey=RFGquavKPUrcCE%2BLmZyFZ02tx6tq7lgkoevDFqgSuH%2FrZMZsdI8akZUk5Qe7tO%2FDFrAV%2FhJbr1ABTxX%2BgnBZmA%3D%3D&pageNo=1&numOfRows=10&sj="+sj;
        try{
